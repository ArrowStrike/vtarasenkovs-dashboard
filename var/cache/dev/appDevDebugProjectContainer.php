...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' => 'get163144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service',
            '2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' => 'get263144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service',
            'add_message' => 'getAddMessageService',
            ...
            'ms_listener' => 'getMsListenerService',
        ...
        $this->privates = array(
            '1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' => true,
            '2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' => true,
    ...
    /**
     * Gets the 'add_message' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DashboardBundle\Services\AddMessageService A DashboardBundle\Services\AddMessageService instance
     */
    protected function getAddMessageService()
    {
        return $this->services['add_message'] = new \DashboardBundle\Services\AddMessageService(${($_ = isset($this->services['memcache']) ? $this->services['memcache'] : $this->get('memcache')) && false ?: '_'}, ${($_ = isset($this->services['debug.event_dispatcher']) ? $this->services['debug.event_dispatcher'] : $this->get('debug.event_dispatcher')) && false ?: '_'}, ${($_ = isset($this->services['doctrine.orm.default_entity_manager']) ? $this->services['doctrine.orm.default_entity_manager'] : $this->get('doctrine.orm.default_entity_manager')) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache_lite'] = new \DashboardBundle\Services\CacheLiteService(3600);
    }
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1']) ? $this->services['1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1'] : $this->get163144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1']) ? $this->services['2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1'] : $this->get263144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDebug_EventDispatcherService()
    {
        ...
        $instance->addListener('message.added', /** @closure-proxy DashboardBundle\Listener\MessageListener::historyAction */ function (\DashboardBundle\Event\MessageAddedEvent $event) {
            return ${($_ = isset($this->services['ms_listener']) ? $this->services['ms_listener'] : $this->get('ms_listener')) && false ?: '_'}->historyAction($event);
        }, 0);
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => 'dan', 'port' => NULL, 'dbname' => 'vtarasenkovs_symfony', 'user' => 'stasadm', 'password' => 'G0a4wa&', 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(${($_ = isset($this->services['annotation_reader']) ? $this->services['annotation_reader'] : $this->get('annotation_reader')) && false ?: '_'}, array(0 => ($this->targetDirs[3].'/src/DashboardBundle/Entity'))), 'DashboardBundle\\Entity');

        $b = new \Doctrine\ORM\Configuration();
        $b->setEntityNamespaces(array('DashboardBundle' => 'DashboardBundle\\Entity'));
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_1307f406ad4781a01a032d0c584c6eee683954449eafcaf6218bb00931a057df');
    ...
    {
        return $this->services['memcache'] = new \DashboardBundle\Repository\MemcacheMessageRepository(${($_ = isset($this->services['cache_lite']) ? $this->services['cache_lite'] : $this->get('cache_lite')) && false ?: '_'});
    }
    ...
    /**
     * Gets the 'ms_listener' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \DashboardBundle\Listener\MessageListener A DashboardBundle\Listener\MessageListener instance
     */
    protected function getMsListenerService()
    {
        return $this->services['ms_listener'] = new \DashboardBundle\Listener\MessageListener(${($_ = isset($this->services['request_stack']) ? $this->services['request_stack'] : $this->get('request_stack')) && false ?: '_'});
    }
    ...
    /**
     * Gets the '1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get163144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service()
    {
        return $this->services['1_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the '2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     ...
     */
    protected function get263144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1Service()
    {
        return $this->services['2_63144d9db3db9417630ff6b1bbe6ee894de52f73559143dbe609d7f28e76ecb1'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder.inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('vbKgjC224r', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fotiQDM3sR', 0, 'mo-1Mgl0XN03f8gY1cHh-G', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('hVMb7tJwGz', 0, 'mo-1Mgl0XN03f8gY1cHh-G', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder.inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('NqQ7b6jOQ+', 0, 'mo-1Mgl0XN03f8gY1cHh-G', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5931a5a9b7e860.20081020');
    }
